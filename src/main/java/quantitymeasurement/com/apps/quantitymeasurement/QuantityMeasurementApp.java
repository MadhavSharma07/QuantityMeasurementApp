...
public class QuantityMeasurementApp {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("////////FIRST OPERAND UNIT SUBTRACTION//////////");
            ...
            Quantity<WeightUnit> subResult2 = demonstrateSubtraction(
                    new Quantity<>(10.0, WeightUnit.KILOGRAM),
                    new Quantity<>(5000.0, WeightUnit.GRAM));
            System.out.println("10 kg - 5000 g = " + subResult2.getValue() + " " + subResult2.getUnit());

            Quantity<VolumeUnit> subResult3 = demonstrateSubtraction(
                    new Quantity<>(5.0, VolumeUnit.LITRE),
                    new Quantity<>(500.0, VolumeUnit.MILLILITRE));
            System.out.println("5 L - 500 mL = " + subResult3.getValue() + " " + subResult3.getUnit());

            Quantity<LengthUnit> subResult4 = demonstrateSubtraction(
                    new Quantity<>(5.0, LengthUnit.FEET),
                    new Quantity<>(10.0, LengthUnit.FEET));
            System.out.println("5 ft - 10 ft = " + subResult4.getValue() + " " + subResult4.getUnit());

            Quantity<LengthUnit> subResult5 = demonstrateSubtraction(
                    new Quantity<>(10.0, LengthUnit.FEET),
                    new Quantity<>(120.0, LengthUnit.INCHES));
            System.out.println("10 ft - 120 in = " + subResult5.getValue() + " " + subResult5.getUnit());

            System.out.println("////////////////CROSS UNIT SUBTRACTION//////////////////");

            Quantity<LengthUnit> subResult6 = demonstrateSubtraction(
                    new Quantity<>(10.0, LengthUnit.FEET),
                    new Quantity<>(6.0, LengthUnit.INCHES),
                    LengthUnit.INCHES);
            System.out.println("10 ft - 6 in = " + subResult6.getValue() + " " + subResult6.getUnit());

            Quantity<WeightUnit> subResult7 = demonstrateSubtraction(
                    new Quantity<>(10.0, WeightUnit.KILOGRAM),
                    new Quantity<>(5000.0, WeightUnit.GRAM),
                    WeightUnit.GRAM);
            System.out.println("10 kg - 5000 g = " + subResult7.getValue() + " " + subResult7.getUnit());

            Quantity<VolumeUnit> subResult8 = demonstrateSubtraction(
                    new Quantity<>(5.0, VolumeUnit.LITRE),
                    new Quantity<>(2.0, VolumeUnit.LITRE),
                    VolumeUnit.MILLILITRE);
            System.out.println("5 L - 2 L = " + subResult8.getValue() + " " + subResult8.getUnit());
            ...
            double divResult2 = demonstrateDivision(
                    new Quantity<>(24.0, LengthUnit.INCHES),
                    new Quantity<>(2.0, LengthUnit.FEET));
            System.out.println("24 in / 2 ft = " + divResult2);

            double divResult3 = demonstrateDivision(
                    new Quantity<>(10.0, WeightUnit.KILOGRAM),
                    new Quantity<>(5.0, WeightUnit.KILOGRAM));
            System.out.println("10 kg / 5 kg = " + divResult3);

            double divResult4 = demonstrateDivision(
                    new Quantity<>(2000.0, WeightUnit.GRAM),
                    new Quantity<>(1.0, WeightUnit.KILOGRAM));
            System.out.println("2000 g / 1 kg = " + divResult4);

            double divResult5 = demonstrateDivision(
                    new Quantity<>(5.0, VolumeUnit.LITRE),
                    new Quantity<>(10.0, VolumeUnit.LITRE));
            System.out.println("5 L / 10 L = " + divResult5);

            double divResult6 = demonstrateDivision(
                    new Quantity<>(1000.0, VolumeUnit.MILLILITRE),
                    new Quantity<>(1.0, VolumeUnit.LITRE));
            System.out.println("1000 mL / 1 L = " + divResult6);
