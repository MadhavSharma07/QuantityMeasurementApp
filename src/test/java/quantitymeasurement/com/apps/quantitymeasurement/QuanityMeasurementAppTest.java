...
class QuantityTest {
    ...
    void testSubtraction_AllMeasurementCategories() {
        ...
        assertEquals(5.0, weightResult.getValue(), EPSILON);

        Quantity<VolumeUnit> volumeResult = new Quantity<>(5.0, VolumeUnit.LITRE)
                .subtract(new Quantity<>(500.0, VolumeUnit.MILLILITRE));
        assertEquals(4.5, volumeResult.getValue(), EPSILON);
    }
    ...
    void testDivision_AllMeasurementCategories() {
        double lengthRatio = new Quantity<>(10.0, LengthUnit.FEET)
                .divide(new Quantity<>(5.0, LengthUnit.FEET));
        assertEquals(2.0, lengthRatio, EPSILON);

        double weightRatio = new Quantity<>(10.0, WeightUnit.KILOGRAM)
                .divide(new Quantity<>(5.0, WeightUnit.KILOGRAM));
        assertEquals(2.0, weightRatio, EPSILON);

        double volumeRatio = new Quantity<>(1000.0, VolumeUnit.MILLILITRE)
                .divide(new Quantity<>(1.0, VolumeUnit.LITRE));
        assertEquals(1.0, volumeRatio, EPSILON);
    }
    ...
    @Test
    void testQuantityMeasurementApp_demonstrateDivision_Weight() {
        double result = QuantityMeasurementApp.demonstrateDivision(
    ...
    @Test
    void testQuantityMeasurementApp_demonstrateDivision_Volume() {
        double result = QuantityMeasurementApp.demonstrateDivision(
